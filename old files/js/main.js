...
// Only run carousel if the element exists
if (petalsContainer) {
...
// Only run if show more button exists
if (showMoreBtn) {
        ...
        if (!isExpanded) {
            ...
            while (currentIndex < additionalFlowers.length) {
                ...
                for (let i = 0; i < flowersPerFrame && currentIndex < additionalFlowers.length; i++) {
                    ...
                    // Add click event to new flowers
                    topPick.addEventListener('click', function() {
                        ...
                        if (img && nameElement && descElement && typeof openExpandedFlower === 'function') {
                            openExpandedFlower(nameElement.textContent, img.src, descElement.textContent);
                        }
                    });
