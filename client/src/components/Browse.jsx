      ...
      <div className="header-left">
        ...
        <div className="search-container" ref={searchContainerRef}>
          ...
          {isSearchFocused && searchQuery.trim().length > 0 && (
            <div className="search-recommendations-grid-container">
              {recommendations.length > 0 ? (
                <div className="search-recommendations-grid">
                  {recommendations.map((flower) => (
                    <div 
                      key={flower._id} 
                      className="top-pick-mini" 
                    ...
                    >
                      ...
                      <div className="description">
                        ...
                        <p className="sort-description">{flower.family || 'Flower'}</p>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      <nav className={`nav-bar ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
        ...
        {isMobileMenuOpen && (
          <div className="mobile-sub-nav">
            <a onClick={() => handleMobileNav('#browse')}>Browse</a>
            <a onClick={() => handleMobileNav('#top-picks')}>Top picks</a>
            <a onClick={() => handleMobileNav('#petals')}>Petals</a>
          </div>
        )}
      </nav>
    </header>
