      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        {showOtp ? (
          ...
          <>
            ...
            <p className="modal-subtitle">{isSignUp ? 'Full access to save favorites and collections' : 'Log in to view your saved flowers'}</p>

            {error && <div className="modal-error-msg">{error}</div>}

            <form className="modal-form" onSubmit={handleSubmit}>
              <input type="email" className="modal-input" placeholder="Enter your email address" value={email} onChange={(e) => setEmail(e.target.value)} required />
              <input type="password" className="modal-input" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} required />
